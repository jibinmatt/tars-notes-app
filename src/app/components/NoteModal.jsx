    ...
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      ...
      >
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M14.1163 5H12.31V3.75H16.25V7.69H15V5.88375L11.6925 9.1925L10.8075 8.3075L14.1163 5ZM5 14.1163L8.3075 10.8075L9.1925 11.6925L5.88375 15H7.69V16.25H3.75V12.31H5V14.1163Z"
                  fill="black"
                />
              </svg>
            </button>
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              >
                <path
                  className={`${
                    newData.isFavorite ? "fill-yellow-400" : "fill-[#c7c7c7]"
                  }`}
            ...
            >
              ...
              >
                <path
                  d="M16.6667 3.33337L3.33337 16.6667M3.33337 3.33337L16.6667 16.6667"
                  stroke="black"
                  strokeWidth="3"
                  strokeLinecap="round"
                />
        ...
        <div className="flex w-full flex-col">
          ...
          />
          <p className="mb-4 text-lg text-[#c4c4c4] justify-start">
            {data?.notes?.createdAt ? data.notes.createdAt : timeStamp}
          </p>
        </div>
        {data?.audio && (
